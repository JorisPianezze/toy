SUBROUTINE FUNCTION_SENT(IOUTDIAG_UNIT,INDI_BEG,INDI_END,INDJ_BEG,INDJ_END, &
  ...
  REAL, PARAMETER    :: DP_LENGTH= 1000.0
  ...
  INTEGER             :: I,J
  !
  REAL, INTENT(OUT)         :: FNC_ANA(NI,NJ,NBFIELDS)
  !
  REAL, INTENT(IN)          :: COORDS_1(NI,NJ)
  REAL, INTENT(IN)          :: COORDS_2(NI,NJ)
  !
  ...
  ELSE IF (CTYPE_FCT .EQ. 'FILES') THEN
    CALL READ_FORCING(IOUTDIAG_UNIT,NBFIELDS,INDI_BEG,INDI_END,INDJ_BEG,INDJ_END,IB,CNAME_FILE,CSNDFIELDS, &
                      & NI,NJ,COORDS_1,COORDS_2,FNC_ANA)
  ELSE
